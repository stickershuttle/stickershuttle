-- Fix Pro Order Generation Log Table Foreign Key
-- This script drops and recreates the table with the correct foreign key relationship

-- Drop the existing table (this will also drop the foreign key constraint)
DROP TABLE IF EXISTS pro_order_generation_log CASCADE;

-- Recreate the table with the correct foreign key relationship
