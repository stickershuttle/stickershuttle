...
-- Check if RLS is enabled (removed forcerowsecurity column)
...
-- 3. Create or update functions with proper security
...
-- 4. Create function to update profile photo
...
-- 5. Create function to update banner image
...
-- 6. Create function to update company name
...
-- 7. Create comprehensive profile update function
...
-- Check that RLS is enabled (fixed query)
