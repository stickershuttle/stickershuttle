-- Fix the get_user_orders function to include tracking fields
-- This version includes the tracking fields that the GraphQL API expects

-- First drop the existing function
DROP FUNCTION IF EXISTS get_user_orders(UUID);

-- Recreate with tracking fields included
