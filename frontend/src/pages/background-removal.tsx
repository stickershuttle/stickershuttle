        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-300 text-sm">Advanced AI technology automatically detects and removes backgrounds with precision.</p>
            </div>
            ...
            >
              ...
              <p className="text-gray-300 text-sm">Get your background-free images in seconds, ready for immediate download and use.</p>
            </div>
            ...
            >
              ...
              <p className="text-gray-300 text-sm">Maintains image quality while delivering clean, professional transparent backgrounds.</p>
            </div>
          </div>
        </div>
      </div>
