...
export default function HolographicStickers() {
        ...
        if (typeof window !== 'undefined' && window.fbq) {
          try {
            window.fbq('track', 'ViewContent', {
              content_ids: ['holographic-stickers'],
              content_name: 'Holographic Stickers',
              content_category: 'Stickers',
              content_type: 'product'
            });
            console.log('📊 Facebook Pixel: ViewContent tracked for Holographic Stickers');
          } catch (fbError) {
  ...
  return (
    <Layout 
      title="Holographic Stickers - Rainbow Iridescent | Sticker Shuttle"
      description="Stunning holographic stickers that shift and shimmer with rainbow colors - perfect for making your designs stand out with iridescent brilliance."
      ogImage="https://res.cloudinary.com/dxcnvqk6b/image/upload/v1749652826/StickerShuttle_Banner_CustomStickers_g73u56.jpg"
    >
      <style jsx>{`
        .container-style {
