...
import StickerSheetsCalculator from "@/components/sticker-sheets-calculator";
...
export default function StickerSheets() {
  ...
  return (
    <Layout 
      title="Sticker Sheets - Multiple Designs | Sticker Shuttle"
      description="Cost-effective sticker sheets with multiple designs per sheet - perfect for bulk orders, variety packs, and efficient distribution."
      ogImage="https://res.cloudinary.com/dxcnvqk6b/image/upload/v1749652816/StickerShuttle_Banner_StickerSheets2_xkkl0c.jpg"
    >
      <style jsx>{`
        .container-style {
      ...
      <section className="pt-[20px] pb-2 md:pb-4">
        <div className="w-[95%] md:w-[90%] xl:w-[95%] 2xl:w-[75%] mx-auto px-4">
          <div 
            ...
            style={{
              backgroundImage: 'url(https://res.cloudinary.com/dxcnvqk6b/image/upload/v1749652816/StickerShuttle_Banner_StickerSheets2_xkkl0c.jpg)',
            ...
            <div className="text-left md:text-left text-center relative z-10 md:pl-8">
              ...
              <div className="hidden md:block mb-4">
                ...
                <p className="text-gray-300 text-base">
                  Multiple designs on one sheet. Maximum value and variety.
                </p>
              </div>
              ...
              <p className="hidden md:block text-base sm:text-lg mb-6 text-purple-100 max-w-3xl">
                Efficient sticker sheets with multiple designs kiss-cut on one sheet - perfect for businesses, events, or collections with variety and cost savings.
              </p>
