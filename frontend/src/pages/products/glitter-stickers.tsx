...
import GlitterStickerCalculator from "@/components/glitter-sticker-calculator";
...
export default function GlitterStickers() {
  ...
  return (
    <Layout 
      title="Glitter Stickers - Sparkle & Shine | Sticker Shuttle"
      description="Eye-catching glitter stickers that sparkle and shine with every angle - perfect for adding glamour and personality to any surface."
      ogImage="https://res.cloudinary.com/dxcnvqk6b/image/upload/v1749850157/4206232a-44b1-48f2-8f22-d0b9f3559868.png"
    >
      <style jsx>{`
        .container-style {
      ...
      <section className="pt-[20px] pb-2 md:pb-4">
        <div className="w-[95%] md:w-[90%] xl:w-[95%] 2xl:w-[75%] mx-auto px-4">
          <div 
            ...
            style={{
              backgroundImage: 'url(https://res.cloudinary.com/dxcnvqk6b/image/upload/v1749850157/4206232a-44b1-48f2-8f22-d0b9f3559868.png)',
