        ...
        <div className="w-[95%] md:w-[90%] xl:w-[95%] 2xl:w-[75%] mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <aside className="lg:w-72 flex-shrink-0">
              <div className="container-style rounded-xl p-6 space-y-8 sticky top-6">
                {/* Filter Header */}
            ...
            <main className="flex-1 min-w-0 space-y-8">
              ...
              {selectedCategories.includes("all") && !showSaleItems && !searchQuery.trim() && (
                ...
                <div 
                  className="rounded-xl p-8 cursor-pointer transition-all duration-200 hover:scale-[1.025] group h-48 relative overflow-hidden"
                  style={{
                    backgroundImage: 'url(https://res.cloudinary.com/dxcnvqk6b/image/upload/v1749652894/StickerShuttle_Banner_PurpleCustomStickers_zxst8r.webp)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                ...
                >
                  <div 
                    ...
                    style={{
                      background: 'linear-gradient(135deg, rgba(99, 102, 241, 0.8) 0%, rgba(67, 56, 202, 0.6) 100%)'
                    }}
                  ></div>
                  <div className="relative z-10 text-left h-full flex flex-col justify-between">
                    <div>
                      <div className="inline-block px-3 py-1 bg-yellow-400/20 text-yellow-300 rounded-full text-sm font-medium mb-3">
                        Premium Pack
                      </div>
                      <h3 className="text-2xl font-bold text-white group-hover:text-indigo-200 transition-colors mb-2">
                        Ultimate Sticker Collection
                      </h3>
                      <p className="text-gray-200 text-sm">
                        50+ premium stickers • Holographic • Vinyl • Chrome
                      </p>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="text-white">
                        <span className="text-2xl font-bold">$24.99</span>
                        <span className="text-gray-300 text-sm ml-2 line-through">$39.99</span>
                      </div>
                ...
                >
                  ...
                  <div className="relative z-10 text-left h-full flex flex-col justify-between">
                    <div>
                      ...
                      <h3 className="text-2xl font-bold text-white group-hover:text-pink-200 transition-colors mb-2">
                        Viral Meme Pack
                      </h3>
                      <p className="text-gray-200 text-sm">
                ...
                {/* For the Holidays */}
                <div 
                  className="rounded-xl p-6 cursor-pointer transition-all duration-200 hover:scale-105 group h-32 relative overflow-hidden"
                  style={{
                    backgroundImage: 'url(https://res.cloudinary.com/dxcnvqk6b/image/upload/v1749652894/StickerShuttle_Banner_PurpleCustomStickers_zxst8r.webp)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
