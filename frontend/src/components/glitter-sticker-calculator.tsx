...
export default function GlitterStickerCalculator({ initialBasePricing, realPricingData }: GlitterStickerCalculatorProps) {
  ...
  const calculatePrice = (qty: number, area: number, isRushOrderParam: boolean, vibrancyBoost: boolean = false) => {
    ...
    if (realPricingData && realPricingData.basePricing && realPricingData.quantityDiscounts) {
      ...
      let adjustedTotal = realResult.totalPrice * whiteOptionMultiplier * glitterMultiplier;
      let adjustedPerSticker = realResult.finalPricePerSticker * whiteOptionMultiplier * glitterMultiplier;
                      ...
                      <button
                        ...
                        style={{
                          border: isSelected && !isGoldTier ? '1.5px solid rgba(34, 197, 94, 0.5)' : 
                                 isSelected && isGoldTier ? '1.5px solid rgba(234, 179, 8, 0.5)' : undefined
                        }}
                      >
