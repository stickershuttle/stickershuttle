                          ...
                          ${
                            isSelected
                              ...
                              : isGoldTier && hoveredGoldTier === numericAmount
                                ? "bg-gradient-to-r from-yellow-500/20 via-amber-400/20 to-yellow-600/20 text-yellow-100 border-2 border-dashed border-yellow-400/40 shadow-lg shadow-yellow-500/10"
            ...
            <div className="container-style p-4 lg:p-6 transition-colors duration-200">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  {!uploadedFile ? (
                    <div 
                      className="border-2 border-dashed border-white/20 rounded-xl p-8 text-center hover:border-purple-400 transition-colors cursor-pointer backdrop-blur-md relative animate-subtle-pulse"
                      onDrop={handleDrop}
